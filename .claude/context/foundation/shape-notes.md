...
<!-- Seed idea: "a mealprep app that helps you buy groceries and cook meals daily" -->
...
### Recipes
- FR-010: ~~User can save a meal as a favorite.~~ **DROPPED** — out of v1 scope. Favorites only add value after several plan cycles; moved to v2 backlog.
...
- FR-004: A 7-day plan goes stale mid-week as real life disrupts it. Mid-week plan regeneration and day-level flexibility are deferred to v2. Risk: users may abandon plans by Wednesday; monitor in v1 user feedback.
